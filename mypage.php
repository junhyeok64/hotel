                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="book_tabel_item">
                                        ...
                                        <div class="form-group">
                                            <div class='input-group' id=''>
                                                <input type='text' class="form-control" placeholder="Phone Number" name="phone" maxlength="11" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class='input-group' id=''>
                                                <input type='text' class="form-control" placeholder="Password" name="password" maxlength="20" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
